...
/* SPCI_RUN helpers */
#define SPCI_RUN_COMP_REASON_SHIFT       U(0)
#define SPCI_RUN_COMP_REASON_MASK        U(0xf)
#define SPCI_RUN_COMP_REASON_DONE        U(0)
#define SPCI_RUN_COMP_REASON_INTR        U(1)
#define SPCI_RUN_COMP_REASON_MSG         U(2)
#define SPCI_RUN_COMP_REASON_YLD         U(3)
#define SPCI_RUN_COMP_REASON_DONE_MSG    U(4)

#define SPCI_RUN_MSG_TARGET_SHIFT       U(4)
#define SPCI_RUN_MSG_TARGET_MASK        U(0xff)
...
/* Type of architectural memory region: RX or TX buffer */
#define SPCI_BUF_DESC_FLAG_TYPE_SHIFT	U(0)
#define SPCI_BUF_DESC_FLAG_TYPE_MASK	U(0x1)
#define SPCI_BUF_DESC_FLAG_TYPE_RX	U(0)
#define SPCI_BUF_DESC_FLAG_TYPE_TX	U(1)
#define SPCI_BUF_DESC_FLAG_TYPE(type)	(((type) & SPCI_BUF_DESC_FLAG_TYPE_MASK)	\
					 << SPCI_BUF_DESC_FLAG_TYPE_SHIFT)
...
typedef struct spci_buf_info_desc {
	...
	uint16_t id;
	uuid_t   uuid;
} spci_buf_info_desc_t;

#define SPCI_BUF_TABLE_SIGNATURE	"MBT"

#define SPCI_BUF_TABLE_ATTR_GRAN_SHIFT	U(0)
#define SPCI_BUF_TABLE_ATTR_GRAN_MASK	U(0x3)
#define SPCI_BUF_TABLE_ATTR_GRAN_4K	U(0)
#define SPCI_BUF_TABLE_ATTR_GRAN_16K	U(1)
#define SPCI_BUF_TABLE_ATTR_GRAN_64K	U(2)
#define SPCI_BUF_TABLE_ATTR_GRAN_RES	U(3)
#define SPCI_BUF_TABLE_ATTR_GRAN(gran)	(((gran) & SPCI_BUF_TABLE_ATTR_GRAN_MASK) \
					 << SPCI_BUF_TABLE_ATTR_GRAN_SHIFT)

#define SPCI_BUF_TABLE_ATTR_PGCNT_SHIFT	U(2)
#define SPCI_BUF_TABLE_ATTR_PGCNT_MASK	U(0xf)
#define SPCI_BUF_TABLE_ATTR_PGCNT(cnt)	(((cnt) & SPCI_BUF_TABLE_ATTR_PGCNT_MASK) \
					 << SPCI_BUF_TABLE_ATTR_PGCNT_SHIFT)

#define SPCI_BUF_TABLE_ATTR(cnt, gran)			\
	(SPCI_BUF_TABLE_ATTR_GRAN(gran)	|	\
	 SPCI_BUF_TABLE_ATTR_PGCNT(cnt))
